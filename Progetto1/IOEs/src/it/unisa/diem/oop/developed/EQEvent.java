...
public class EQEvent implements Comparable<EQEvent> {
    ...
    public String toString() {
        return "EQEvent{" + "eventID=" + eventID + ", time=" + time + ", latitude=" + latitude + ", longitude=" + longitude + ", depthKm=" + depthKm + ", author=" + author + ", catalog=" + catalog + ", contributor=" + contributor + ", contributorID=" + contributorID + ", magType=" + magType + ", magnitude=" + magnitude + ", magAuthor=" + magAuthor + ", eventLocationName=" + eventLocationName + '}';
    }
